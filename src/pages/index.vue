              ...
              <v-card-text class="pa-8">
                ...
                <div class="text-center mb-8">
                  <div class="app-icon mb-4">
                    <v-icon size="64" color="error">mdi-account-network</v-icon>
                  </div>
                ...
                <div class="mb-6">
                  ...
                  >
                    ...
                    <v-btn value="client" class="flex-grow-1">
                ...
                <v-form @submit.prevent="handleLogin" ref="loginForm">
                  ...
                  <div class="text-center">
                    <v-btn variant="text" color="error" size="small"> Forgot Password? </v-btn>
                  </div>
                </v-form>
...
const handleLogin = async () => {
  ...
  try {
    ...
    if (loginType.value === "client") {
      ...
      // Navigate to admin/officer dashboard
...
.login-main {
  min-height: 100vh;
  background: linear-gradient(135deg, #1a1a1a 0%, #2d1b1b 25%, #3d1a1a 50%, #2d1b1b 75%, #1a1a1a 100%);
  position: relative;
}
